...
namespace Tighten\Illuminate\Compilers;
...
class BladeCompiler extends Compiler implements CompilerInterface
{
     ...
     */
    protected function getOpenAndClosingPhpTokens($contents) : array
    {
        return array_filter(array_map(function ($token) {
            return $token == 0;
        }, token_get_all($contents)), function ($token) {
    ...
    {
        if (strpos($value, '(') === 0 && strpos($value, ')') === strlen($value)) {
